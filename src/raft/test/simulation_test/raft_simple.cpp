...
TEST(RaftSimple, Replica3Client1) {
  for (size_t seed = 0; seed < 30; ++seed) {
    mtf::raft::test::RunSimpleTest(seed, 3, 1);
    if (testing::Test::HasNonfatalFailure()) {
      return;
    }
  }
...
TEST(RaftSimple, Replica3Client2) {
  for (size_t seed = 0; seed < 30; ++seed) {
    mtf::raft::test::RunSimpleTest(seed + 100, 3, 2);
    if (testing::Test::HasNonfatalFailure()) {
      return;
    }
  }
...
TEST(RaftSimple, Replica5Client3) {
  for (size_t seed = 0; seed < 30; ++seed) {
    mtf::raft::test::RunSimpleTest(seed + 200, 5, 3);
    if (testing::Test::HasNonfatalFailure()) {
      return;
    }
  }
...
TEST(RaftSimple, Replica6Client10) {
  for (size_t seed = 0; seed < 30; ++seed) {
    mtf::raft::test::RunSimpleTest(seed + 300, 6, 10);
    if (testing::Test::HasNonfatalFailure()) {
      return;
    }
  }
